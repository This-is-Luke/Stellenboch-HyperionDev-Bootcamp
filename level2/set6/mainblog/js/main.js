console.log(
	'Good day. This will only run inside a live server environment. You will have to open the folder in VS Code using Live Server for marking to test functionality. Alternatively, you can view the blog running live on my website by clicking blog on my projects below. thisisluke.co.za/innerPages/projects.html'
);
/*
------------------
like functionality
...
document.querySelectorAll('.like-btn').forEach((button) => {
	...
	let likes =
		...
		Math.floor(Math.random() * (20000 - 10000 + 1) + 10000); // initialize to a random number between 10000 and 20000
